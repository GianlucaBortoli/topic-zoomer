...
\section{Solution}
This section describes in detail all the steps to realize this tool, from the initial web page download to the map-reduce operations taken by Spark. The presentation order reflects the one followed during the experiments.
